...
public class EntryArea {
    ...
    public TelefonEntry getSelectedEntries() {
        return tableView.getSelectionModel().getSelectedItem();
    }

    public void selectItems(List<TelefonEntry> items){
        tableView.getSelectionModel().setSelectionMode(SelectionMode.MULTIPLE);
        Iterator<TelefonEntry> telefonEntryIterator = items.iterator();
        while (telefonEntryIterator.hasNext()) {
            tableView.getSelectionModel().select(telefonEntryIterator.next());
        }
    }
